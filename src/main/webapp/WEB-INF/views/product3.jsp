			...
			<div class="wrap">
				<div class="nav two">
					<ul>
						<li ><a href="${ctx }/view/menusToUrl?url=product">毛绒公仔</a></li>
						<li ><a href="${ctx }/view/menusToUrl?url=product2">家居用品</a></li>
						<li class="on"><a href="${ctx }/view/menusToUrl?url=product3">IP衍生品</a></li>
					</ul>
				</div>
				<div class="crumbs">
					<ul>
		...
		<div class="aboutPage">
			<div class="wrap">
				<div class="columnTitle">
					<h2 class="tit">IP衍生品介绍</h2>
					<div class="entit">Derivation product introduction</div>
					<div class="line"></div>
				</div>
				      ...
				      beforeSend:function(){
		      		  ...
		      		  success: function (result) {
		      			 ...
		      			 $(result.data.rows).each(function(i,o){
							...
							+'<div class="btn"><a href="${ctx }/view/menusToUrl?url=product-con3&paramName=id&paramNum='+o.id+'" target="_blank">了解详情</a></div>'
