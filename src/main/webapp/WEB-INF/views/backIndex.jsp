...
<body>
    ...
    <script src="${ctx }/static/tc/lun/koala.min.1.5.js"></script>
    ...
    <!--Page Level JS-->
    <script src="${ctx }/static/tc/plugins/countTo/jquery.countTo.js"></script>
    <script src="${ctx }/static/tc/plugins/weather/js/skycons.js"></script>
    <script src="${ctx }/static/tc/plugins/daterangepicker/moment.min.js"></script>
    <script src="${ctx }/static/tc/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- ChartJS  -->
    <script src="${ctx }/static/tc/plugins/chartjs/Chart.min.js"></script>
    <!-- Morris  -->
    <script src="${ctx }/static/tc/plugins/morris/js/morris.min.js"></script>
    <script src="${ctx }/static/tc/plugins/morris/js/raphael.2.1.0.min.js"></script>
    <!-- Vector Map  -->
    <script src="${ctx }/static/tc/plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="${ctx }/static/tc/plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js"></script>
    <!-- Calendar  -->
    <script src="${ctx }/static/tc/plugins/calendar/clndr.js"></script>
    <script src="${ctx }/static/tc/plugins/calendar/clndr-demo.js"></script>
